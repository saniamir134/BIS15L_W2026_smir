...
ggplot(data=elephants,
       mapping=aes(x=tusk_length_in_cm, y=estimated_age_years))+
  geom_smooth(method=lm, se=T)+
  labs(title="age vs tusk length",
       x="tusk length (cm)", y= "age (yrs)")
```
...
```{r}
ggplot(data=elephants,
       mapping=aes(x=tusk_length_in_cm, y=shoulder_height_in_cm))+
  geom_smooth(method=lm, se=T)+
  labs(title="shoulder height (cm) vs tusk length",
       x="tusk length (cm)", y= "shoulder height (cm)")
```
...
```{r}
elephants %>% 
  count(tusk_length_in_cm, years_of_sample_collection)
```
...
```{r}
ggplot(mature_elephants, 
       aes(x = years_of_sample_collection, y = tusk_length_in_cm)) +
  geom_boxplot() +
  labs(title = "Tusk length of mature elephants", x = "yrs", y = "Tusk length (cm)")
```
